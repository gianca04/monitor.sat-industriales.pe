...
class StoreRequirementRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'items.required' => 'Debe agregar al menos un material a la lista del requerimiento.',
            ...
            'items.*.item_id.required' => 'Cada material debe contener un identificador de ítem válido.',
            ...
            'items.*.quantity.required' => 'Debe especificar la cantidad para cada material.',
